...
|---|---|---|---|
| [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/GenomicsMachineLearning/ASI_FIMSA_2026/blob/main/notebooks/00_setup_check.ipynb) | **00 · Setup check** | Confirms Colab can install the packages and reach the data. Run it at home, not in the room. | ~10 min |
| [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/GenomicsMachineLearning/ASI_FIMSA_2026/blob/main/notebooks/01_read_and_visualise.ipynb) | **01 · Read and visualise** | Load and plot all three platforms — Visium spots, Xenium cells, and the whole-transcriptome Atera run — and see what each one can and cannot resolve. | ~35 min |
